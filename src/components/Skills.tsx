          ...
          <TabsContent value="technical" className="animate-fade-in">
            <div className="grid md:grid-cols-2 gap-6">
              {technicalSkills.map((skill) => (
                <Card key={skill.name} className="card-hover backdrop-blur-sm bg-white/50 dark:bg-background/50 border-primary/10 overflow-hidden transition-all duration-300">
          ...
          <TabsContent value="soft" className="animate-fade-in">
            <div className="grid md:grid-cols-3 gap-6">
              {softSkills.map((skill) => (
                <Card key={skill.name} className="card-hover backdrop-blur-sm bg-white/50 dark:bg-background/50 border-primary/10 overflow-hidden relative group">
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-center group-hover:bg-gradient-to-r group-hover:from-primary group-hover:to-blue-500 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">{skill.name}</CardTitle>
                  </CardHeader>
                  <CardContent>
