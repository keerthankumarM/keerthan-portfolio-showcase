      ...
      <div className="container relative z-10 flex flex-col-reverse md:flex-row items-center justify-between gap-10 h-screen pt-20">
        ...
        <div className="flex-1 flex justify-center md:justify-end">
          <div className="relative group">
            ...
            <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-gradient-to-r from-purple-400 via-pink-400 to-blue-400 shadow-2xl relative z-10 bg-slate-800 group-hover:scale-105 transition-transform duration-300">
              <img 
                src="https://i.postimg.cc/PqqdGySg/IMG-20250522-WA0019.jpg" 
                alt="Keerthan Kumar M" 
                className="w-full h-full object-cover object-bottom group-hover:scale-105 transition-transform duration-300 filter brightness-110 contrast-110 saturate-110"
